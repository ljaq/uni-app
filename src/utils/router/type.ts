 ...
 * Router 跳转参数混合类型
 */
export declare type RouterLocationMixtureRaw<T, K extends keyof T = keyof T> = Pick<T, Exclude<keyof T, K>> &
  {
...
export declare type RouterLocationRaw =
  | string
  | RouterLocationMixtureRaw<RouteLocationOptions & LocationUniAppParams, RouterLocationRequiredOnly>;
